...
contract TestContract {
    ...
    function test1() public {
        assembly {
            sstore(1, 1) /* inline comment*/ // forgefmt: disable-line
            sstore(2, 2)
        }
    }
    ...
    function test2() public {
        assembly {
            sstore(1, 1) // forgefmt: disable-line
            sstore(2, 2)
...
library MyLib {
    ...
    bytes32 private constant TYPE_HASH_1 =
        keccak256(
            "MyStruct("
            "uint8 myEnum,"
            "address myAddress"
    ...
    // forgefmt: disable-start
    bytes32 private constant TYPE_HASH_2 =
        keccak256(
            "MyStruct("
            "uint8 myEnum,"
            "address myAddress"
