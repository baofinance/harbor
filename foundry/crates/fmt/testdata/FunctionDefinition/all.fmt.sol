...
interface FunctionInterfaces {
    ...
    function someParamsSomeModifiers(uint256 x1, uint256 x2, uint256 x3) modifier1 modifier2 modifier3;

    function someParamsSomeReturns(uint256 x1, uint256 x2, uint256 x3) returns (uint256 y1, uint256 y2, uint256 y3);

    function someModifiersSomeReturns() modifier1 modifier2 modifier3 returns (uint256 y1, uint256 y2, uint256 y3);

    function someParamSomeModifiersSomeReturns(
        uint256 x1,
        uint256 x2,
        uint256 x3
    ) modifier1 modifier2 modifier3 returns (uint256 y1, uint256 y2, uint256 y3);
    ...
    function modifierOrderCorrect01() public view virtual override modifier1 modifier2 returns (uint256);
    ...
    function modifierOrderCorrect04() internal virtual override modifier1 modifier2 returns (uint256);

    function modifierOrderIncorrect01() public view virtual override modifier1 modifier2 returns (uint256);

    function modifierOrderIncorrect02() external virtual override modifier1 modifier2 returns (uint256);

    function modifierOrderIncorrect03() internal pure virtual modifier1 modifier2 returns (uint256);

    function modifierOrderIncorrect04() external payable override modifier1 modifier2 returns (uint256);
}
