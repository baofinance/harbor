contract UsingExampleContract {
    ...
    using {These, Are, MultipleLibraries, ThatNeedToBePut, OnSeparateLines} for uint256;
    using {This.isareally.longmember.access.expression.that.needs.to.besplit.into.lines} for uint256;
