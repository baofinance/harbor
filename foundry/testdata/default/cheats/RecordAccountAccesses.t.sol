...
contract RecordAccountAccessesTest is DSTest {
    ...
    function testRecordAccountAccesses() public {
        ...
        string
            memory expectedStateDiff = "0x000000000000000000000000000000000000162e\n- balance diff: 0 \xE2\x86\x92 1000000000000000000\n\n";
    ...
    function testConstructorStorage() public {
        ...
        try
            create2or.create2(bytes32(0), abi.encodePacked(type(ConstructorStorer).creationCode, abi.encode(true)))
        {} catch {}
        ...
        assertEq(
            ...
            Vm.AccountAccess({
                ...
                data: abi.encodePacked(
                    type(SelfDestructor).creationCode,
                    abi.encode(address(bytes20("doesn't exist yet")))
                ),
                reverted: false,
                storageAccesses: new Vm.StorageAccess[](0),
                depth: 3
     ...
     */
    function filterExtcodesizeForLegacyTests(
    ...
    function assertEq(
        Vm.AccountAccess memory actualAccess,
        Vm.AccountAccess memory expectedAccess,
        bool checkStorage
    ) internal {
