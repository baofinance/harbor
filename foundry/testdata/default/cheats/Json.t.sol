...
library JsonStructs {
    ...
    function deserializeFlatJson(
        string memory json,
        string memory path
    ) internal pure returns (ParseJsonTest.FlatJson memory) {
        return abi.decode(vm.parseJsonType(json, path, schema_FlatJson), (ParseJsonTest.FlatJson));
    }

    function deserializeFlatJsonArray(
        string memory json,
        string memory path
    ) internal pure returns (ParseJsonTest.FlatJson[] memory) {
    ...
    function deserializeNestedJson(
        string memory json,
        string memory path
    ) internal pure returns (ParseJsonTest.NestedJson memory) {
        return abi.decode(vm.parseJsonType(json, path, schema_NestedJson), (ParseJsonTest.NestedJson));
    }

    function deserializeNestedJsonArray(
        string memory json,
        string memory path
    ) internal pure returns (ParseJsonTest.NestedJson[] memory) {
        return abi.decode(vm.parseJsonType(json, path, schema_NestedJson), (ParseJsonTest.NestedJson[]));
