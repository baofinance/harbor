    ...
    fallback() external payable {
        assembly {
...

            {
                ...
                if iszero(
                    and(
                        // The arguments of `and` are evaluated last to first.
                        and(
            ...
            for {
                ...
                for {
                    let o := or(and(shr(245, shl(i, u1)), 0x600), and(shr(247, shl(i, u2)), 0x180))
                } o {
                ...
                for {
                    let o := or(and(shr(243, shl(i, u1)), 0x600), and(shr(245, shl(i, u2)), 0x180))
                } o {
