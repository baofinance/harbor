...
| config | 10 | 1 | 5 | 2 | – | 1 | 1 |
| script (live) | 5 | 2 | 1 | – | – | 2 | – |
| script (archive) | 20 | 4 | – | – | – | 2 | 14 |
| doc | 25 | 1 | – | 6 | – | 3 | 15 |
| **Total** | **70** | **11** | **9** | **10** | **2** | **8** | **30** |
...
| id | location | finding |
|---|---|---|
| `38f49611` | `claim.md:9-26` | Update the claim ABI to the v3 interface |
| `df535dfd` | `claim.md:9-26` | Same — **duplicate** of `38f49611` |
| `4aa09fe1` | `claim.md:41-46` | Format reward amounts using each token's decimals |
| `10ba8d94` | `claim.md:109-117` | Replace the outdated Minter ABI and calls |
| `d10d09b8` | `claim.md:111-117` | Add `maxFeeRatio` to the minter examples |
| `55883954` | `claim.md:194-199` | Fix the undefined variable in the proportional split example |
| `f0c57f82` | `claim.md:194-199` | Same — **duplicate** of `55883954` |
| `19f21952` | `display.md:23-46` | Fix the APR example before publishing it |
| `f6320b94` | `redeem.md:38-44` | Limit the `1e18` blocked-value rule to supported operations |
| `ffbfc808` | `stability-pool.md:24-52` | Include every documented claim overload in the minimal ABI |
| `4e2d4df3` | `stability-pool.md:279-297` | Pass `provider` into `getAllClaimableRewards` |
| `f3d57c65` | `tokens.md:11-17` | Correct the `rewardData` tuple order and fields |
| `ac1a14ff` | `troubleshooting.md:273-286` | Use the configured mock feed addresses |
...
| id | location | finding |
|---|---|---|
| `fea3d21a` | `DataEnvelope.md:103-114` | "Do not ship the known harvest-allocation flaw as an accepted behavior" — challenges a documented-as-accepted behaviour |
| `53af2580` | `DataEnvelope.md:103-107` | Reconcile the documented rebalance overflow behaviour |
| `ceeb58b9` | `autocompounding-vault-design.md:223-227` | Reconcile the HarborYield valuation model |
| `182c6c4d` | `harbor-deployment.md:217-219` | Do not treat `1e12` base units as universally dust |
| `b4e6f1f1` | `ideas/rebalance-fairness.md:443-459` | Use the combined fee in the attack example |
