...
plot datafile using ($2):($3 < 1 ? $3 : NaN) with lines linewidth 1 linetype 1, \
     ...
     datafile1 using ($2):($3 < 1 ? $3 : NaN) with lines linewidth 2 dashtype 2 linetype 1, \
     datafile1 using ($2):($4 < 1 ? $4 : NaN) with lines linewidth 2 dashtype 2 linetype 2, \
     datafile1 using ($2):($5 < 1 ? $5 : NaN) with lines linewidth 2 dashtype 2 linetype 4, \
     datafile1 using ($2):($6 < 1 ? $6 : NaN) with lines linewidth 2 dashtype 2 linetype 6
