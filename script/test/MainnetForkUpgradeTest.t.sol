...
contract MainnetForkUpgradeTest is Test {
    ...
    address testUser;
    address testRewardDepositor;

    function setUp() public {
        vm.createSelectFork(vm.rpcUrl("local"));

        testUser = makeAddr("testUser");
        testRewardDepositor = makeAddr("testRewardDepositor");

        // ---- Register all 22 pools (proxy, minter, label) ----
        // BTC::fxUSD
        pools.push(PoolConfig(0x86561cdB34ebe8B9abAbb0DD7bEA299fA8532a49, 0x33e32ff4d0677862fa31582CC654a25b9b1e4888, "BTC_fxUSD_col"));
        pools.push(PoolConfig(0x9e56F1E1E80EBf165A1dAa99F9787B41cD5bFE40, 0x33e32ff4d0677862fa31582CC654a25b9b1e4888, "BTC_fxUSD_lev"));
        // BTC::stETH
        pools.push(PoolConfig(0x667Ceb303193996697A5938cD6e17255EeAcef51, 0xF42516EB885E737780EB864dd07cEc8628000919, "BTC_stETH_col"));
        pools.push(PoolConfig(0xCB4F3e21DE158bf858Aa03E63e4cEc7342177013, 0xF42516EB885E737780EB864dd07cEc8628000919, "BTC_stETH_lev"));
        // ETH::fxUSD
        pools.push(PoolConfig(0x1F985CF7C10A81DE1940da581208D2855D263D72, 0xd6E2F8e57b4aFB51C6fA4cbC012e1cE6aEad989F, "ETH_fxUSD_col"));
        pools.push(PoolConfig(0x438B29EC7a1770dDbA37D792F1A6e76231Ef8E06, 0xd6E2F8e57b4aFB51C6fA4cbC012e1cE6aEad989F, "ETH_fxUSD_lev"));
        // EUR::fxUSD
        pools.push(PoolConfig(0xe60054E6b518f67411834282cE1557381f050B13, 0xDEFB2C04062350678965CBF38A216Cc50723B246, "EUR_fxUSD_col"));
        pools.push(PoolConfig(0xc5e0dA7e0a178850438E5E97ed59b6eb2562e88E, 0xDEFB2C04062350678965CBF38A216Cc50723B246, "EUR_fxUSD_lev"));
        // EUR::stETH
        pools.push(PoolConfig(0x000564B33FFde65E6c3b718166856654e039D69B, 0x68911ea33E11bc77e07f6dA4db6cd23d723641cE, "EUR_stETH_col"));
        pools.push(PoolConfig(0x7553fb328ef35aF1c2ac4E91e53d6a6B62DFDdEa, 0x68911ea33E11bc77e07f6dA4db6cd23d723641cE, "EUR_stETH_lev"));
        // GOLD::fxUSD
        pools.push(PoolConfig(0xC1EF32d4B959F2200efDeDdedadA226461d14DaC, 0x880600E0c803d836E305B7c242FC095Eed234A8f, "GOLD_fxUSD_col"));
        pools.push(PoolConfig(0x5bDED171f1c08B903b466593B0E022F9FdE8399c, 0x880600E0c803d836E305B7c242FC095Eed234A8f, "GOLD_fxUSD_lev"));
        // GOLD::stETH
        pools.push(PoolConfig(0x215C28DcCe0041eF9a17277CA271F100d9F345CF, 0xB315DC4698DF45A477d8bb4B0Bc694C4D1Be91b5, "GOLD_stETH_col"));
        pools.push(PoolConfig(0x2af96e906D568c92E53e96bB2878ce35E05dE69a, 0xB315DC4698DF45A477d8bb4B0Bc694C4D1Be91b5, "GOLD_stETH_lev"));
        // MCAP::fxUSD
        pools.push(PoolConfig(0x7928a145Eed1374f5594c799290419B80fCd03f0, 0x3d3EAe3a4Ee52ef703216c62EFEC3157694606dE, "MCAP_fxUSD_col"));
        pools.push(PoolConfig(0x8CF0C5F1394E137389D6dbfE91c56D00dEcdDAD8, 0x3d3EAe3a4Ee52ef703216c62EFEC3157694606dE, "MCAP_fxUSD_lev"));
        // MCAP::stETH
        pools.push(PoolConfig(0x4cFf4948A0EA73Ee109327b56da0bead8c323189, 0xe37e34Ab0AaaabAc0e20c911349c1dEfAD0691B6, "MCAP_stETH_col"));
        pools.push(PoolConfig(0x505bfC99D2FB1A1424b2A4AA81303346df4f27E9, 0xe37e34Ab0AaaabAc0e20c911349c1dEfAD0691B6, "MCAP_stETH_lev"));
        // SILVER::fxUSD
        pools.push(PoolConfig(0x7619664fe05c9cbDA5B622455856D7CA11Cb8800, 0x177bb50574CDA129BDd0B0F50d4E061d38AA75Ef, "SILVER_fxUSD_col"));
        pools.push(PoolConfig(0x24AEf2d27146497B18df180791424b1010bf1889, 0x177bb50574CDA129BDd0B0F50d4E061d38AA75Ef, "SILVER_fxUSD_lev"));
        // SILVER::stETH
        pools.push(PoolConfig(0x1C9c1cF9aa9fc86dF980086CbC5a5607522cFc3E, 0x1c0067BEe039A293804b8BE951B368D2Ec65b3e9, "SILVER_stETH_col"));
        pools.push(PoolConfig(0x4C0F988b3c0C58F5ea323238E9d62B79582738e6, 0x1c0067BEe039A293804b8BE951B368D2Ec65b3e9, "SILVER_stETH_lev"));

        // ---- Known depositors (discovered via cast logs) ----
        // BTC::fxUSD::stabilityPoolLeveraged - known from failed withdrawal tx
        poolDepositors[0x9e56F1E1E80EBf165A1dAa99F9787B41cD5bFE40].push(0xb9ab9578a34a05c86124c399735fdE44dEc80E7F);
        // TODO: Discover more depositors by running:
        //   TOPIC0=$(cast sig-event "Deposit(address indexed,address indexed,uint256)")
        //   cast logs --rpc-url $MAINNET_RPC_URL --address <POOL> --from-block 0 --to-block 24404265 $TOPIC0
    }
    ...
    function _serializeHeader(string memory version) internal {
        ...
        vm.serializeString(_jsonKey, "desc_pendingRewards_ok", "Whether pendingRewards() succeeded (false = broken pool)");
    ...
    function _serializeRewardToken(address proxy, address token, string memory ri) internal {
        ...
        {
            (uint256 lastUpdate, uint256 finishAt, uint256 rate, uint256 queued) =
                IMultipleRewardDistributor(proxy).rewardData(token);
        ...
        try IMultipleRewardDistributor(proxy).pendingRewards(token) returns (
            uint256 distributable, uint256 undistributed
        ) {
    ...
    function _serializeUser(
        ...
        for (uint256 t = 0; t < activeTokens.length; t++) {
            ...
            _serializeUint(string.concat(ut, "_claimable"), IMultipleRewardAccumulator(proxy).claimable(user, activeTokens[t]));
            _serializeUint(string.concat(ut, "_claimed"), IMultipleRewardAccumulator(proxy).claimed(user, activeTokens[t]));
        }
    }
    ...
    function _serializePoolState(address proxy, address[] memory depositors, string memory prefix) internal {
        // Pool-global views
        {
            ...
            vm.serializeString(_jsonKey, string.concat(prefix, "_liquidationToken"), vm.toString(pool.LIQUIDATION_TOKEN()));
    ...
    function _doInteractions(address proxy, string memory prefix) internal {
        ...
        // 2. Deposit reward (need REWARD_DEPOSITOR_ROLE)
        {
            address liquidationToken = IStabilityPool(proxy).LIQUIDATION_TOKEN();
            vm.prank(IBaoOwnable(proxy).owner());
            IBaoRoles(proxy).grantRoles(
                testRewardDepositor,
                IMultipleRewardDistributor(proxy).REWARD_DEPOSITOR_ROLE()
            );

            deal(liquidationToken, testRewardDepositor, 10 ether);
            vm.startPrank(testRewardDepositor);
        ...
        // 3. Warp 1 week (full reward period)
        {
            uint256 warpDuration = uint256(IMultipleRewardDistributor(proxy).REWARD_PERIOD_LENGTH());
            vm.warp(block.timestamp + warpDuration);
            _serializeUint(string.concat(prefix, "_warp_seconds"), warpDuration);
        }

        // 4. Claim for existing depositors
        {
        ...
        // 5. Withdraw for test user (request, warp into window, withdraw)
        vm.startPrank(testUser);
    ...
    function test_captureState() public {
        ...
        vm.writeJson(
            ...
            string.concat("tmp/", version, "_pre.json")
        );
        ...
        vm.writeJson(
            vm.serializeString(_jsonKey, "_complete", "true"),
            string.concat("tmp/", version, "_post.json")
        );
