...
contract UpdateVolatility_OGPlus is SafeBatch {
    function build() internal override {
        ...
        queue(
            _saltString("GOLD", "fxUSD", "stabilityPoolManager"),
