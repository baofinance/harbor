...
/// @notice Collateral configuration for wstETH markets (wrapped stETH as collateral).
/// @dev Addresses come from the chain config that this is composed with.
abstract contract ConfigCollateral_wstETH_mainnet is ConfigChain_mainnet {
