...
import {ConfigCollateral_BTC_megaeth} from "../collaterals/ConfigCollateral_BTC_megaeth.sol";
...
/// @notice Market configuration for USD::BTC (megaeth).
contract ConfigMarket_USD_BTC_megaeth is
    Config_MinterMarket,
    ConfigChain_megaeth,
    ConfigPeg_USD,
    ConfigCollateral_BTC_megaeth,
