...
import {ConfigCollateral_wBTC_mainnet} from "../collaterals/ConfigCollateral_wBTC_mainnet.sol";
...
/// @notice Market configuration for USD::wBTC (mainnet).
contract ConfigMarket_USD_wBTC_mainnet is
    Config_MinterMarket,
    ConfigChain_mainnet,
    ConfigPeg_USD,
    ConfigCollateral_wBTC_mainnet,
