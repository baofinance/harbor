...
import {ConfigCollateral_wstETH_mainnet} from "../collaterals/ConfigCollateral_wstETH_mainnet.sol";
...
/// @notice Market configuration for USD::wstETH (mainnet).
contract ConfigMarket_USD_wstETH_mainnet is
    Config_MinterMarket,
    ConfigChain_mainnet,
    ConfigPeg_USD,
    ConfigCollateral_wstETH_mainnet,
