...
import {ConfigCollateral_stETH_megaeth} from "../collaterals/ConfigCollateral_stETH_megaeth.sol";
...
/// @notice Market configuration for USD::stETH (megaeth).
contract ConfigMarket_USD_stETH_megaeth is
    Config_MinterMarket,
    ConfigChain_megaeth,
    ConfigPeg_USD,
    ConfigCollateral_stETH_megaeth,
