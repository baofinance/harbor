...
import {Config_MinterMarket_GOLD_stETH} from "./Config_MinterMarket_GOLD_stETH.sol";
import {MinterMarketConfigLib} from "../../ConfigBase.sol";

/// @notice Mainnet wiring for GOLD::stETH minter market config.
contract Config_MinterMarket_GOLD_stETH_mainnet is Config_Chain_Mainnet, Config_MinterMarket_GOLD_stETH {
