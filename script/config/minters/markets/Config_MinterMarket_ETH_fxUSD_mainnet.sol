...
import {Config_MinterMarket_ETH_fxUSD} from "./Config_MinterMarket_ETH_fxUSD.sol";
import {MinterMarketConfigLib} from "../../ConfigBase.sol";

/// @notice Mainnet wiring for ETH::fxUSD minter market config.
contract Config_MinterMarket_ETH_fxUSD_mainnet is Config_Chain_Mainnet, Config_MinterMarket_ETH_fxUSD {
