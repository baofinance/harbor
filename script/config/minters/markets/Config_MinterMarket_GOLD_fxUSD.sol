...
/// @notice Minter market config for GOLD::fxUSD.
abstract contract Config_MinterMarket_GOLD_fxUSD is
    Config_MinterMarket,
    IMarketConfig,
    Config_Peg_GOLD,
    ...
    Config_Minter_Common
{
    ...
    function peg() public pure override(Config_Peg_GOLD, IMarketConfig) returns (string memory) {
        return Config_Peg_GOLD.peg();
    }
