...
import {Config_MinterMarket_BTC_stETH} from "./Config_MinterMarket_BTC_stETH.sol";
import {MinterMarketConfigLib} from "../../ConfigBase.sol";

/// @notice Mainnet wiring for BTC::stETH minter market config.
contract Config_MinterMarket_BTC_stETH_mainnet is Config_Chain_Mainnet, Config_MinterMarket_BTC_stETH {
