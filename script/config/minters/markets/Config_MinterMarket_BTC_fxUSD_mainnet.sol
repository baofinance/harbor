...
import {Config_MinterMarket_BTC_fxUSD} from "./Config_MinterMarket_BTC_fxUSD.sol";
import {MinterMarketConfigLib} from "../../ConfigBase.sol";

/// @notice Mainnet wiring for BTC::fxUSD minter market config.
contract Config_MinterMarket_BTC_fxUSD_mainnet is Config_Chain_Mainnet, Config_MinterMarket_BTC_fxUSD {
