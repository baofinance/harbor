...
contract ConfigPriceVolatility_115_stable is ConfigPriceVolatilityBase {
    ...
    function minterConfig() public pure override returns (IMinter.Config memory) {
        ...
        mintPeggedBounds[2] = 1.30e18;
        mintPeggedBounds[3] = 1.35e18;
        mintPeggedBounds[4] = 1.40e18;
        mintPeggedBounds[5] = 1.50e18;

        int256[] memory mintPeggedRatios = new int256[](7);
        mintPeggedRatios[0] = 1e18;
        mintPeggedRatios[1] = 1.5e16;
        mintPeggedRatios[2] = 1e16;
        mintPeggedRatios[3] = 0.66e16;
        ...
        redeemPeggedBounds[2] = 1.14e18;
        redeemPeggedBounds[3] = 1.25e18;
        redeemPeggedBounds[4] = 1.40e18;
        redeemPeggedBounds[5] = 1.50e18;
        ...
        redeemLeveragedBounds[1] = 1.14e18;
        redeemLeveragedBounds[2] = 1.25e18;
        redeemLeveragedBounds[3] = 1.35e18;
        redeemLeveragedBounds[4] = 1.45e18;
        redeemLeveragedBounds[5] = 1.55e18;
