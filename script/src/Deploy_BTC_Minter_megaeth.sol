...
import {ConfigMarket_BTC_USDMY_megaeth} from "script/config/markets/ConfigMarket_BTC_USDMY_megaeth.sol";
import {Config_MinterMarket} from "script/config/ConfigBase.sol";

/// @notice BTC-specific minter deployment for MegaETH (USDMY collateral).
abstract contract Deploy_BTC_Minter_megaeth is DeployMintersShared {
    function createBTCMintersConfig() internal returns (ConfigPeg peg, Config_MinterMarket[] memory markets) {
        ...
        markets[0] = new ConfigMarket_BTC_USDMY_megaeth();
    }
}
