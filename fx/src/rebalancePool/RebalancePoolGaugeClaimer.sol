...
contract RebalancePoolGaugeClaimer is Ownable2Step {
    ...
    event UpdateSplitterRatio(
        uint256 leverageRatioLowerBound,
        uint256 leverageRatioUpperBound,
    ...
    constructor(address _reservePool, address _treasury, address _gauge, address _splitter) {
